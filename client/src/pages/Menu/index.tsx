...
const Menu = observer(() => {
    const {
        ...
        learnerStore: { reset, setEnglishToJapanese, library },
        settingsStore: {
            flag,
            language,
            showDescription,
                ...
                <Grid w={"50rem"} maw={"100vw"} p={"1rem"}>
                    <Grid.Col span={6}>
                        <Card shadow="xl" radius="md">
                            ...
                            <Space h={"sm"} />
                            <Text>
                                The easiest way to start learning a language is
                                by practicing common words. This way you can
                                quickly build a vocabulary and start speaking
                                the language.
                            </Text>
                            <Space h={"xl"} />
                            <Title order={2}>
