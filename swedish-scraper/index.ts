...
const scrapeTopSpanishWords = async () => {
    const translations: {
        word: string;
        description: string;
        translation: string[];
    ...
    await page.goto(
        "https://1000mostcommonwords.com/1000-most-common-swedish-words/"
    );
    ...
    try {
        ...
        for (const row of rows) {
            ...
            if (swedish === "swedish" && english === "in english") continue;
            translations.push({
                word: swedish || "",
                description: "",
                translation: [english || ""],
